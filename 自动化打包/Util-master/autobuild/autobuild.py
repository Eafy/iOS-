...
CODE_SIGN_IDENTITY = "iPhone Distribution: Pingfei He (K5LE4LDJCG)"
PROVISIONING_PROFILE_SPECIFIER = 
#PROVISIONING_PROFILE = "9f79bfc9-c431-43cd-bc84-5d8e2b5a5b28"
...
def buildProject(project, scheme):
	...
	archiveCmd = 'xcodebuild -project %s -scheme %s -configuration %s archive -archivePath %s -destination generic/platform=iOS CODE_SIGN_IDENTITY=%s' %(project, scheme, CONFIGURATION, archivePath, CODE_SIGN_IDENTITY)
